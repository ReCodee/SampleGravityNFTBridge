    ...
    <div>
      ...
      <Container sm="true">
        ...
        <Card css={{ $$cardColor: "#00000042", marginBottom: "$5" }}>
          ...
          <Checkbox css={{ml:"$10"}} size="md" color="success" isSelected={customPay} onChange={useToken}>Pay with<img className='ml-3' src='GravityLogo.png' width="100px" /></Checkbox>
      ...
      >
        ...
        <img
          src="GravityLogo.png"
          style={{ maxWidth: "150px", opacity: "90%"}}
        />
        </Modal.Header>
